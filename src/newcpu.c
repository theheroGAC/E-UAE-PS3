...
static void build_cpufunctbl (void)
{
  ...
  LOG_MSG2("Build CPU table, %i opcodes    \n", opcnt);
...
{
	LOG_MSG("m68k_run_2  - n0 \n");
}

static void m68k_run_2p (void)
{
	LOG_MSG("m68k_run_2p  - n0 \n");
}
